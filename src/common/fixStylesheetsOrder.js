export default function fixStylesheetsOrder(isRTL) {
  if (isRTL) {
    ...
    if (mainCss.nextElementSibling.getAttribute("href").includes('/assets/css/rtl_style.css')) return;
    ...
    if (bootstrapCss.nextElementSibling.getAttribute("href").includes('/assets/css/style.css')) return;
